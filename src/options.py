...
class TrainOptions():
  def __init__(self):
    ...
    self.parser.add_argument('--model_save_freq', type=int, default=30, help='freq (epoch) of saving models')
    ...
    self.parser.add_argument('--n_ep_decay', type=int, default=100, help='epoch start decay learning rate, set -1 if no decay')
    ...
    self.parser.add_argument('--b2a', type=int, default=1, help='translation direction, 1 for a2b, 0 for b2a') 
...
class TestOptions():
  def __init__(self):
    ...
    self.parser.add_argument('--val_path', type=str, default='../datasets/test_rain100L', help='path of testing data')     

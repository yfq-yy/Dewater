...
class Saver():
  def __init__(self, opts):
    self.display_dir = os.path.join(opts.display_dir, opts.name) #../logs Rain100L
    self.model_dir = os.path.join(opts.result_dir, opts.name)  #../results
    self.image_dir = os.path.join(self.model_dir, 'images')
    self.dict_dir = os.path.join(self.model_dir, 'dicts')    
    self.display_freq = opts.display_freq #1
    self.img_save_freq = opts.img_save_freq #1
    self.model_save_freq = opts.model_save_freq #10
